...
The Angular frontend has moved to `../frontend`. Run and containerize the frontend from that folder; this gateway project now builds as a backend service only.
...
Node is no longer required for gateway development. The Angular project, npm scripts, and frontend tooling live in `../frontend`.
...
Run the gateway backend from this folder:
...
To build the final jar and optimize the NexaFlow application for production, run:
