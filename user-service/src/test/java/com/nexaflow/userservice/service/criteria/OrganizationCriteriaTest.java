...
class OrganizationCriteriaTest {
    ...
    void newOrganizationCriteriaHasAllFiltersNullTest() {
        ...
        assertThat(organizationCriteria).is(criteriaFiltersAre(Objects::isNull));
    }
    ...
    void organizationCriteriaFluentMethodsCreatesFiltersTest() {
        ...
        assertThat(organizationCriteria).is(criteriaFiltersAre(Objects::nonNull));
    }
    ...
    private static void setAllFilters(OrganizationCriteria organizationCriteria) {
        ...
        organizationCriteria.name();
        organizationCriteria.slug();
        organizationCriteria.description();
        organizationCriteria.createdAt();
        organizationCriteria.updatedAt();
        organizationCriteria.active();
