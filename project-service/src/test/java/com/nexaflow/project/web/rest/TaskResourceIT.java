...
import static com.nexaflow.project.domain.TaskAsserts.*;
...
class TaskResourceIT {
    ...
    private static final String DEFAULT_ASSIGNED_USER_LOGIN = "AAAAAAAAAA";
    private static final String UPDATED_ASSIGNED_USER_LOGIN = "BBBBBBBBBB";
    ...
    public static Task createEntity(EntityManager em) {
        Task task = new Task()
            ...
            .assignedUserLogin(DEFAULT_ASSIGNED_USER_LOGIN)
    ...
    public static Task createUpdatedEntity(EntityManager em) {
        Task updatedTask = new Task()
            ...
            .assignedUserLogin(UPDATED_ASSIGNED_USER_LOGIN)
    ...
    void getAllTasks() throws Exception {
        ...
        restTaskMockMvc
            ...
            .andExpect(jsonPath("$.[*].assignedUserLogin").value(hasItem(DEFAULT_ASSIGNED_USER_LOGIN)))
    ...
    void getTask() throws Exception {
        ...
        restTaskMockMvc
            ...
            .andExpect(jsonPath("$.assignedUserLogin").value(DEFAULT_ASSIGNED_USER_LOGIN))
